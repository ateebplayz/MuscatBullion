...
function AdminLogin() {
    ...
    useEffect(() => {
        const checkToken = async () => {
            const req = await axios.get(`http://muscatbullionproject.grabyourservices.com:5000/api/users/verify/${token}`)
    ...
    const handleLoginButton = async () => {
        const req = await axios.post('http://muscatbullionproject.grabyourservices.com:5000/api/users', credentials)    
