...
function AdminLogin() {
    ...
    useEffect(() => {
        const checkToken = async () => {
            const req = await axios.get(`https://prices.grabyourservices.com:9000/api/users/verify/${token}`)
    ...
    const handleLoginButton = async () => {
        const req = await axios.post('https://prices.grabyourservices.com:9000/api/users', credentials)    
