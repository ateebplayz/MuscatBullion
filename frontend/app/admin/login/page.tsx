...
function AdminLogin() {
    ...
    useEffect(() => {
        const checkToken = async () => {
            const req = await axios.get(`https://api.muscatbullion.com:9000/api/users/verify/${token}`)
    ...
    const handleLoginButton = async () => {
        const req = await axios.post('https://api.muscatbullion.com:9000/api/users', credentials)    
